...
interface CodeForgeLogoEnhancedProps {
  size?: number
  className?: string
  color?: 'gradient' | 'white' | 'blue'
}

export const CodeForgeLogoEnhanced = ({ 
  size = 64, 
  className = "",
  color = "gradient"
}: CodeForgeLogoEnhancedProps) => {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      <defs>
        {/* Gradiente sincronizado com o nome CodeForge */}
        <linearGradient id="logoGradientEnhanced" x1="0%" y1="0%" x2="100%" y2="0%">
          <stop offset="0%" stopColor="#3b82f6">
            <animate
              attributeName="stop-color"
              values="#3b82f6;#1e40af;#2563eb;#3b82f6"
              dur="3s"
          ...
          <stop offset="50%" stopColor="#1e40af">
            <animate
              attributeName="stop-color"
              values="#1e40af;#2563eb;#3b82f6;#1e40af"
              dur="3s"
              repeatCount="indefinite"
            />
          </stop>
          <stop offset="100%" stopColor="#2563eb">
            <animate
              attributeName="stop-color"
              values="#2563eb;#3b82f6;#1e40af;#2563eb"
              dur="3s"
              repeatCount="indefinite"
            />
          </stop>
        ...
        {/* Gradiente azul claro para a logo */}
        <linearGradient id="logoGradientBlue" x1="0%" y1="0%" x2="100%" y2="0%">
          <stop offset="0%" stopColor="#60a5fa" />
          <stop offset="50%" stopColor="#3b82f6" />
          <stop offset="100%" stopColor="#2563eb" />
        </linearGradient>
        
        {/* Filtro de brilho sincronizado */}
      ...
      {/* Logo original com gradiente animado, branco ou azul */}
      <g 
        transform="translate(0.000000,567.000000) scale(0.100000,-0.100000)"
        fill={color === 'white' ? '#ffffff' : color === 'blue' ? "url(#logoGradientBlue)" : "url(#logoGradientEnhanced)"}
        stroke="none"
        filter={color === 'white' ? "none" : "url(#glowEnhanced)"}
      >
...
105 -5 -4 -9 -1 -145 132 -53 50 -98 92 -100 92 -2 0 -26 -29 -52 -65z"/>
      ...
      {/* Efeito de partículas sincronizadas */}
      <circle
        cx="80"
        cy="80"
        r="2"
        fill={color === 'white' ? '#3b82f6' : color === 'blue' ? '#60a5fa' : "url(#logoGradientEnhanced)"}
        opacity="0.6"
      ...
      <circle
        ...
        cy="80"
        r="1.5"
        fill={color === 'white' ? '#1e40af' : color === 'blue' ? '#3b82f6' : "url(#logoGradientEnhanced)"}
        opacity="0.7"
        className="animate-ping"
        style={{
      ...
      <circle
        ...
        cy="487"
        r="2"
        fill={color === 'white' ? '#2563eb' : color === 'blue' ? '#2563eb' : "url(#logoGradientEnhanced)"}
        opacity="0.8"
        className="animate-ping"
        style={{
      ...
      <circle
        ...
        cy="487"
        r="1.5"
        fill={color === 'white' ? '#60a5fa' : color === 'blue' ? '#93c5fd' : "url(#logoGradientEnhanced)"}
        opacity="0.6"
        className="animate-ping"
        style={{
          animation: 'ping 3s cubic-bezier(0, 0, 0.2, 1) infinite 1.5s'
        }}
      />
    </svg>
  )
...
export default CodeForgeLogoEnhanced
